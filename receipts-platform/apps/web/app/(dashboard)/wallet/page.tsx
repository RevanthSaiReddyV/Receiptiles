    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="mt-6 bg-white rounded-2xl border border-zinc-200/60 shadow-sm p-5">
        ...
        <p className="text-xs text-zinc-400 mb-4">
          Keep your AllMyReceipts card in Apple Wallet or Google Wallet.
          It updates automatically as you add more receipts.
        </p>
        <div className="flex flex-col sm:flex-row gap-3">
          {/* Apple Wallet */}
          <button
            className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-black px-5 py-3 text-sm font-medium text-white hover:bg-zinc-800 transition-colors"
            onClick={() => alert("Apple Wallet requires Apple Developer account. Sign up at developer.apple.com — your pass will be ready once activated.")}
          >
