    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="mt-6 bg-white rounded-2xl border border-zinc-200/60 shadow-sm p-5">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          {/* Apple Wallet */}
          <div className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-black/30 px-5 py-3 text-sm font-medium text-zinc-400 cursor-not-allowed">
