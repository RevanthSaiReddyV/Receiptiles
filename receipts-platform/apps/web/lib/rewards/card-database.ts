...
export const MERCHANT_CATEGORIES: Record<string, string> = {
  ...
  // --- NEW: Only merchants not already in the database above ---
  ...
  "NAPA Auto Parts": "Shopping",
  "Discount Tire": "Shopping",
  "Firestone": "Shopping",
  "Jiffy Lube": "Shopping",
  "Valvoline": "Shopping",
  "National": "Travel",
  "Barnes and Noble": "Entertainment",
  "Guitar Center": "Shopping",
  "Newegg": "Electronics",
  "Gopuff": "Shopping",
  "Bath and Body Works": "Shopping",
  "The Vitamin Shoppe": "Drugstores",
  "Vitamin Shoppe": "Drugstores",
};
